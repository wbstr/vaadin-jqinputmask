 ...
 * @author kumm
 */
public class DateOptions extends AbstractOptions<DateOptions> {

    public DateOptions(AbstractClientConnector target, String fn) {
        super(target, fn);
    }
    ...
    public DateOptions yearrange(int minyear, int maxyear) {
